/*****************************************
* Create the bjjbbe_my_guitar_shop1 database
*****************************************/
DROP DATABASE IF EXISTS bjjbbe_my_guitar_shop1;
CREATE DATABASE bjjbbe_my_guitar_shop1;
USE bjjbbe_my_guitar_shop1;  -- MySQL command
...
/*****************************************
* Create the bjjbbe_my_guitar_shop2 database
*****************************************/
DROP DATABASE IF EXISTS bjjbbe_my_guitar_shop2;
CREATE DATABASE bjjbbe_my_guitar_shop2;
USE bjjbbe_my_guitar_shop2;
